...
**Versión del sistema:** Fase 15 — Multi-Model Support & Embeddings Desacoplados
...
| 15 | **Multi-Model Support** | **`EMBEDDING_MODEL` desacoplado, fix ScenarioGenerator hardcode, guía Qwen3/Gemma 4** |
